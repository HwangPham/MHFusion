...
def parse_args():
    ...
    parser.add_argument('-c', '--checkpoint', default='checkpoint', type=str, metavar='PATH',
                        help='checkpoint multi-hypotheses directory')
    ...
    # Add regression head type argument
    parser.add_argument('-rh', '--regression-head', default='mlp', type=str, metavar='HEAD', help='Type of regression head')
    ...
    parser.add_argument('-sampling_timesteps', type=int, default=10, metavar='N', help='sampling_timesteps')
